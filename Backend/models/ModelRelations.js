...
PurchaseRequest.belongsTo(Department, { foreignKey: "departmentId", as: "Department" });
...
PurchaseOrder.belongsTo(PurchaseRequest, { foreignKey: "prId", as: "purchase_request" });
PurchaseRequest.hasOne(PurchaseOrder, { foreignKey: "prId", as: "purchase_order" });
